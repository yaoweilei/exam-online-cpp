...
- Invitation acceptance is now strict: the receiving user must log in and verify the exact invited email or phone before `/api/v2/organizations/invitations/accept` succeeds.
