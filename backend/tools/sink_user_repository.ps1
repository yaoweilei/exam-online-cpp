...
$headerPath = Join-Path $root 'backend\src\infrastructure\storage\UserRepository.h'
$cppPath    = Join-Path $root 'backend\src\infrastructure\storage\UserRepository.cpp'
