...
//   GET /api/v1/auth/oauth/{provider}/start          → 302 跳转到授权页（mock 模式直接到 callback）
//   GET /api/v1/auth/oauth/{provider}/callback       → 完成登录，写 token cookie 并 302 回 /
//
