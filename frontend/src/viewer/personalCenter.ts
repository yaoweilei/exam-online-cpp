...
interface ManagedOrganizationMember {
	userId: string;
	username: string;
	memberNo?: string;
	roles: string[];
...
interface ManagedOrganizationInvitation {
	invitationId: string;
	inviteToken: string;
	channel: 'email' | 'phone';
	contact: string;
...
interface ManagedOrganizationAuditLog {
	auditId: string;
	action: string;
	summary: string;
...
interface OrganizationMemberDraft {
	searchQuery: string;
...
interface ContactVerificationDraft {
	email: string;
	emailCode: string;
	phone: string;
	phoneCode: string;
...
type ContactVerificationKind = 'email' | 'phone';
