...
// ---------------------------------------------------------------------------
// SRS 间隔重复 路由（业务功能 7）
//   GET    /api/v2/srs/{userId}/due?limit=20   待复习卡列表
//   GET    /api/v2/srs/{userId}/cards          全部卡（管理/调试）
//   POST   /api/v2/srs/{userId}/review         { card_id, grade(0-3) }
//   POST   /api/v2/srs/{userId}/cards          { exam_id, question_id, question_type?, snapshot? } 手工入卡
//   DELETE /api/v2/srs/{userId}/cards/{cardId}
// ---------------------------------------------------------------------------
