...
class QuestionMapManager {
    ...
    questionMapContainer = null;
    questionMapContent = null;
    ...
    renderQuestionMap() {
        ...
        categories.forEach((category) => {
            ...
            category.sectionIndexes.forEach((sectionIndex) => {
                ...
                section.questions.forEach((question, questionIndex) => {
                    ...
                    const isCurrent = sectionIndex === this.examViewer.currentSectionIndex &&
        ...
        this.questionMapContent.addEventListener('click', (event) => {
            ...
            const item = target?.closest('.question-map-item');
            if (!item) {
                return;
            }
    ...
    refreshQuestionMapHighlight() {
        ...
        const currentItem = this.questionMapContent.querySelector(`.question-map-item[data-section="${this.examViewer.currentSectionIndex}"][data-question="${this.examViewer.currentQuestionIndex}"]`);
        if (currentItem) {
...
//# sourceMappingURL=QuestionMapManager.js.map